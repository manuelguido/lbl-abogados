                            ...
                            <div class="card-body p-4">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-lg-6">
                                        <h1 class="h4 w500 black1">Contactanos<i class="fas fa-info-circle primary-dark ml-2 info-icon"><span class="info-icon-text">Formulario de contacto extendido</span></i></h1>
                                        <form action="{{ url('/new_message') }}" method="POST">
                                            ...
                                            <div class="form-row mb-3">
                                                <div class="col-12">
                                                    ...
                                                    <input type="tel" name="phone" class="form-control" placeholder="Ingresa tu teléfono" required>
                                                </div>
                                            </div>
                                            <div class="form-row mb-3">
                                                <div class="col-12">
                                            ...
                                            <div class="form-row mt-4">
                                                <div class="col-12">
                                                    <button type="submit" class="btn btn-primary btn-block m-0 py-3">Enviar</button>
                                                </div>                                                
                                            </div>
                                        </form>
                                    </div>
